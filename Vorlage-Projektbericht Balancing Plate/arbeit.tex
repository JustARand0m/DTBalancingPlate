...
\studentttt{Philipp Kramer}	% Studierender
{1234456}						% Matrikelnummer
{Technische Informatik}			% Studiengang

\studenttttt{Patrick Lesch}	% Studierender
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale = 0.44]{pics/SkizzeAufbau}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale = 0.44]{pics/BildGrundplatte}
...
% ----------------------------------------------------------------------------------
% Kapitel 2.8: UDP-Socket
% ----------------------------------------------------------------------------------
\subsection{UDP-Socket}
\textit{Von Patrick Lesch}\newline

% ----------------------------------------------------------------------------------
% Kapitel 2.9: IOS-Appliaktion
% ----------------------------------------------------------------------------------
...
\section {Bestelliste}
\begin{tabularx}{\textwidth}{p{0.25\textwidth}|X|X|X|X|X|X|}
